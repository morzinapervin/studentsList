...
const data = [
  ...
  const container = document.querySelector('.pagination')
    ...
    window.addEventListener('DOMContentLoaded', function () {
      ...
      // displayStudentList
      function displayStudentList(datalist){

        let displayStudent = datalist.map(function(item) {
        ...
        displayStudent = displayStudent.join("");
...
const pagination_element = document.getElementById('pagination');
  ...
  DisplayList(data, list_element, rows, current_page )
      ...
      ///////////////////// this file is for the search option    /////// //////////
      // this codes find item in the current page not in all pages
...
searchtextbox.addEventListener('input', function(){
    ...
    Array.from(lilist).forEach(function(item){
        let searchedtext = item.getElementsByTagName('h3')[0].innerText
